...
function law_scripts() {
	...
	wp_enqueue_style( 'owl-theme-default-css', get_template_directory_uri() . '/assets/css/owl.theme.default.min.css' );
	...
	wp_enqueue_script('respond-js', get_template_directory_uri() .'/assets/js/respond.min.js'); // async
	...
	wp_enqueue_script( 'jquery-stellar', get_template_directory_uri() . '/assets/js/jquery.stellar.min.js', array(), true );
	wp_enqueue_script( 'owl-carousel-js', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', array(), true );
	wp_enqueue_script( 'jquery-flexslider', get_template_directory_uri() . '/assets/js/jquery.flexslider-min.js', array(), true );
	wp_enqueue_script( 'jquery-countTo', get_template_directory_uri() . '/assets/js/jquery.countTo.js', array(), true );
	wp_enqueue_script( 'jquery-magnific-popup', get_template_directory_uri() . '/assets/js/jquery.magnific-popup.min.js', array(), true );
	wp_enqueue_script( 'magnific-popup-options-js', get_template_directory_uri() . '/assets/js/magnific-popup-options.js', array(), true );
	wp_enqueue_script( 'main-js', get_template_directory_uri() . '/assets/js/main.js', array(), true );

	wp_localize_script( 'main-js', 'lawData', array(
...
/**
 * class Law_Header_Menu.
 */
require get_template_directory() . '/inc/Law_Header_Menu.php';
